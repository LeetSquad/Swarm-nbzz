...
from nbzz.cmds.init_funcs import nbzz_full_version_str
from nbzz.protocols.protocol_message_types import ProtocolMessageTypes
from nbzz.protocols.shared_protocol import Capability, Handshake
from nbzz.server.outbound_message import Message, NodeType, make_msg
from nbzz.server.rate_limits import RateLimiter
...
from nbzz.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from nbzz.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSNbzzConnection:
    """
