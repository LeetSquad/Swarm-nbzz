...
def start_cmd(ctx: click.Context, password,bee_key_path) -> None:
    ...
    construct_txn = nbzz_contract.functions.nodeOnline(w3.eth.default_account,w3.eth.default_account).buildTransaction({"nonce":w3.eth.getTransactionCount(my_local_acc.address)}) #start
    print(construct_txn)
