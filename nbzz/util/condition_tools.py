...
from nbzz.types.announcement import Announcement
from nbzz.types.blockchain_format.coin import Coin
from nbzz.types.blockchain_format.program import Program, SerializedProgram
from nbzz.types.blockchain_format.sized_bytes import bytes32
from nbzz.types.condition_opcodes import ConditionOpcode
from nbzz.types.condition_with_args import ConditionWithArgs
from nbzz.util.clvm import int_from_bytes
from nbzz.util.errors import ConsensusError, Err
...
def parse_sexp_to_condition(
    ...
    """
    Takes a NbzzLisp sexp and returns a ConditionWithArgs.
...
def parse_sexp_to_conditions(
    ...
    """
    Takes a NbzzLisp sexp (list) and returns the list of ConditionWithArgss
